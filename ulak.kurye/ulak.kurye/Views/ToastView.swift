...
extension UIView {
    private struct ToastKeys {
        static var timer        = "com.kokteyl.toast.timer"
        static var completion   = "com.kokteyl.toast.completion"
    }
    ...
    enum ToastType {
        ...
        var backgroundColor: UIColor {
            switch self {
            case .error:
                return .init(named: "ulk-red-bold")!
            case .success:
                return .init(named: "ulk-green")!
            }
        }
        ...
        var messageFont: UIFont {
            return .init(name: "Poppins-Regular", size: 16.0)!
        }
    ...
    private func createToastView( _ type: ToastType, message: String) -> UIView {
        ...
        NSLayoutConstraint(item: messageLabel, attribute: .leading, relatedBy: .equal, toItem: imageView, attribute: .trailing, multiplier: 1, constant: type.itemPadding).isActive = true
